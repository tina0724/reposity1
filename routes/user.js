...
*/
router.get(API_ROUTE.list, wrapper(userController.getUserList))
router.post(API_ROUTE.create, wrapper(userController.createUser))
router.delete(API_ROUTE.delete, wrapper(userController.deleteUser))
router.patch(API_ROUTE.update, wrapper(userController.updateUser))
